# TODO: Add option to select the position of the text
...
variables = {"image_source": "Select an image", "text_color": ""}


def watermark(img, w_text):
    draw = ImageDraw.Draw(img)
    font = ImageFont.truetype("./arial.ttf", 32)
    draw.text((0, 0), w_text, variables["text_color"][0], font=font)
